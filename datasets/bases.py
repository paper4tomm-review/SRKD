...
# nltk.download('words')
nltk.data.path.append('/home/zhangpeng/xuanshihao/nltk_data')
...
class ImageTextMAEDataset(Dataset):
    ...
    def filter_sentence(self, sentence):
        ...
        filtered_tokens = [token for token, tag in tagged_tokens if
                           tag.startswith('PRP') or tag.startswith('NN') or tag.startswith('JJ')]
